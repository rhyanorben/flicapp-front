    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-7 gap-1">
          {days.map((day, index) => {
            if (!day) {
              return <div key={index} className="h-24 border border-border"></div>
            }
              ...
              >
                ...
                <div className="space-y-1">
                  {dayAppointments.slice(0, 2).map(appointment => (
                    <Badge 
                      key={appointment.id}
                      variant={appointment.status === 'agendado' ? 'secondary' : 
                               appointment.status === 'confirmado' || appointment.status === 'concluido' ? 'default' : 'destructive'}
